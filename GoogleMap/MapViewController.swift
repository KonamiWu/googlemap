...
final class MapViewController: UIViewController {
    ...
    private let myLocationView = MyLocationView(frame: CGRect(x: 100, y: 100, width: 50, height: 50))
...
//            GMSNavigationServices.showTermsAndConditionsDialogIfNeeded(with: GMSNavigationTermsAndConditionsOptions(companyName: "ThinkAR")) { _ in
//                
//            }
//            
//        }
