...
class AddressPickerViewModel: NSObject {
    @Published private(set) var savedAddress = UserDefaults.standard.savedAddresses
    @Published private(set) var historyAddress = UserDefaults.standard.history
        ...
        keywordSubject
            ...
            .sink { [weak self] text in
                ...
                if text.isEmpty {
                    ...
                    historyAddress = originalHistoryAddress.filter {
                        $0.primaryText.contains(text)
                    }
                }
        ...
        placesClient.findAutocompletePredictions(
            ...
            Task {
                ...
                for prediction in predictions {
                    if let place = await self.fetchCoordinate(placeID: prediction.placeID, sessionToken: sessionToken) {
    ...
    private func fetchCoordinate(placeID: String, sessionToken: GMSAutocompleteSessionToken) async -> GMSPlace? {
