...
class AddressInputView: UIView {
    ...
    private let addressTextSize: CGFloat = 12
    ...
    private func setup() {
        ...
        destinationTextField.font = .systemFont(ofSize: addressTextSize)
        ...
        NSLayoutConstraint.activate([
            ...
            destinationTextField.topAnchor.constraint(equalTo: bottomView.topAnchor),
            destinationTextField.trailingAnchor.constraint(equalTo: bottomClearButton.leadingAnchor),
            destinationTextField.bottomAnchor.constraint(equalTo: bottomView.bottomAnchor)
        ])
        destinationTextField.placeholder = "route_destination_placeholder".localized
